...
namespace cointopay_direct_cc_optional;

class Cointopay_Direct_Cc_Optional
{
    const VERSION = '1.0';
    ...
    public static function request($url, $method = 'GET', $params = array(), $authentication = array())
    {
        ...
        if (empty($merchant_id) || empty($security_code))
            \cointopay_direct_cc_optional\Exception::throwException(400, array('reason' => 'CredentialsMissing'));
