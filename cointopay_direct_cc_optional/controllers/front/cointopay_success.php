...
class Cointopay_Direct_Cc_OptionalCointopay_SuccessModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        try {
           ...
           /* $this->context->smarty->assign(array(
			...
			if (_PS_VERSION_ >= '1.7') {
				$this->setTemplate('module:cointopay_direct_cc_optional/views/templates/hook/ctp_success_callback.tpl');
			} else {
