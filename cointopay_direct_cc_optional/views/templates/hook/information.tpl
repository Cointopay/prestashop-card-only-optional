...
<div id="Information" class="tabcontent">
	<div class="wrapper">
	  <img src="../modules/cointopay_direct_cc_optional/views/img/invoice.png" style="float:right;"/>
	  ...
	  <img src="../modules/cointopay_direct_cc_optional/views/img/currencies.png" style="float:right;"/>
	  <p class="sign-up"><br/>
