...
<section id="cointopay_order_confirmation_section" style="width:80%;display:table;margin:10% auto 0 auto;padding:6% 20px;background-color: #f1f1f1;text-align: center;">
    <h3 class="h3 card-title">Options de carte de credit / Credit card options / Kreditkartenoptionen
     <br>Attention au frais de cartes +2.50€ - Mind the card fees +2.50€ - Achten Sie auf Kartengebühren +2.50€ </br></h3>
...
<form method="post" action="/module/cointopay_direct_cc_optional/callback" id="CoinsPaymentCallBack">
...
<input type="hidden" name="COINTOPAY_DIRECT_CC_OPTIONAL_MERCHANT_ID" id="COINTOPAY_DIRECT_CC_OPTIONAL_MERCHANT_ID" value="{$smarty.get.merchant_id|escape:'htmlall':'UTF-8'}" />
<input type="hidden" name="TransactionID" id="COINTOPAY_DIRECT_CC_OPTIONAL_TransactionID" value="{$smarty.get.TransactionID|escape:'htmlall':'UTF-8'}" />
